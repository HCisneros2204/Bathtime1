...
<html lang="en" >
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
		...
		<link rel="stylesheet" href="../bathtime/CSS2/style.css">
        <link rel="stylesheet" href="../bathtime/CSS/estilosfondo.css">
        <link rel="stylesheet" href="../bathtime/CSS/estilosForm.css">
...
<a href="global/CloseCon1.php">Cerrar Sesion</a>
        ...
        <div class="">
	        ...
	        <ul class="list-unstyled components mb-5">
	          <li class="active" >
	            <a href="../bathtime/InicioA.php" style="text-decoration:none;"><span class="fa fa-home mr-3"></span> Home</a>
	          </li>
	          <li>
